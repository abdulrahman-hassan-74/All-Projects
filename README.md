...
![Alt text](MPR-Viewer/images/1.jpg)
- **You can adjust brightness and contrast for each view**
![Alt text](MPR-Viewer/images/2.jpg)
- **Play and pause cine**
![Alt text](MPR-Viewer/images/3.jpg)
- **Accepts both NIFTI and DICOM files**
![Alt text](MPR-Viewer/images/4.jpg)
- **Crosshair feature to indicate the selected point in the other views**
![Alt text](MPR-Viewer/images/5.jpg)
...
![Alt text]("Playersheatmap\images\1.png")
